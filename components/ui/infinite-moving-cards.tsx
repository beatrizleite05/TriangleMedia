  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-gray-700 bg-black px-8 py-6 md:w-[450px] flex-shrink-0"
            key={item.name}
          >
            <blockquote>
              <div
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  ...
                  {item.title && <span className="text-sm leading-[1.6] text-gray-400 font-normal">{item.title}</span>}
                </span>
              </div>
            </blockquote>
          </li>
